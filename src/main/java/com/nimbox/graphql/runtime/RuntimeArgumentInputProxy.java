...
public class RuntimeArgumentInputProxy implements InvocationHandler {
	...
	private final Map<Method, RuntimeParameterArgument> fields;
	private final Map<String, Object> arguments;

	// constructors

	public RuntimeArgumentInputProxy(RuntimeArgumentFactory factory, Map<Method, RuntimeParameterArgument> fields, Map<String, Object> arguments) {
	...
	public static <T> T proxy(Class<?> inputObjectClass, RuntimeArgumentFactory factory, Map<Method, RuntimeParameterArgument> fields, Map<String, Object> arguments) throws Exception {
